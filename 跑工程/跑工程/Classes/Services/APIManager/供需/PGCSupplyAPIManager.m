...
+ (NSURLSessionDataTask *)addOrMidifySupplyWithParameters:(NSDictionary *)parameters responds:(void (^)(RespondsStatus, NSString *, id))respondsBlock
{
    return [self requestPOST:kAddOrMidifySupply parameters:parameters success:^(NSURLSessionDataTask *task, id responseObject) {
...
{
    return [self requestPOST:kGetSupply parameters:parameters cachePolicy:RequestReloadIngnoringLocalCacheData success:^(NSURLSessionDataTask *task, id responseObject) {
...
{
    return [self requestPOST:kMySupplies parameters:parameters cachePolicy:RequestReloadIngnoringLocalCacheData success:^(NSURLSessionDataTask *task, id responseObject) {
