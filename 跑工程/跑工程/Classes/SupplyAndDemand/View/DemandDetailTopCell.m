...
@property (strong, nonatomic) PGCDetailTitleView *time;/** 时间 */
...
- (void)createUI
{
    ...
    self.time = [[PGCDetailTitleView alloc] initWithTitle:@"时间："];
...
- (void)setTopDemand:(PGCDemand *)topDemand
{
    ...
    self.time.content = [NSString stringWithFormat:@"%@ 至 %@", start, end];
