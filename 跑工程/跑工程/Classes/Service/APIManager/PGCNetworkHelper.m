...
@implementation PGCNetworkHelper
...
{
    //读取缓存
    responseCache ? responseCache([PGCNetworkCache httpCacheForURL:URL parameters:parameters]) : nil;
    ...
    return [_manager GET:URL parameters:parameters progress:^(NSProgress * _Nonnull uploadProgress) {
        ...
        //对数据进行异步缓存
        responseCache ? [PGCNetworkCache setHttpCache:responseObject URL:URL parameters:parameters] : nil;
