...
#import "PGCHttpService.h"

@implementation PGCHttpService
{
    //一般的网络请求服务
...
static PGCHttpService * __singleton__;
...
- (void)invalidateManagers {
    [_dataSessionManager invalidateSessionCancelingTasks:true];
}
...
- (void)initManagers {
    //普通数据请求
    _dataSessionManager = [[AFHTTPSessionManager alloc] initWithBaseURL:[NSURL URLWithString:kBaseURL]];
