...
@interface GPSNaviViewController ()<AMapNaviDriveManagerDelegate, AMapNaviDriveViewDelegate, MoreMenuViewDelegate, UINavigationControllerDelegate>
...
- (void)viewWillLayoutSubviews
{
    ...
    {
        [self.driveView setIsLandscape:false];
    }
    else if (UIInterfaceOrientationIsLandscape(interfaceOrientation))
    {
        [self.driveView setIsLandscape:true];
    }
}
...
- (void)initDriveManager
{
    if (self.driveManager == nil)
    {
        ...
        [self.driveManager setAllowsBackgroundLocationUpdates:true];
        [self.driveManager setPausesLocationUpdatesAutomatically:false];
