...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    tagView.frame = CGRectMake(0, 0, SCREEN_WIDTH, 40);
    return tagView;
}
...
- (UITableView *)tableView {
    if (!_tableView) {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, self.nameLabel.bottom_sd, self.view.width_sd, self.view.height_sd - self.nameLabel.bottom_sd) style:UITableViewStyleGrouped];
