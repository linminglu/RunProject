...
@interface PGCProcurementViewController () <UITableViewDelegate, UITableViewDataSource, JSDropDownMenuDataSource, JSDropDownMenuDelegate, PGCSearchViewDelegate>
{
    NSArray *_areaDatas;
    NSArray *_typeDatas;
    NSArray *_timeDatas;
...
{
    self.navigationItem.title = @"招标采购";
...
- (void)registerNotification {
    [PGCNotificationCenter addObserver:self selector:@selector(loadProcurementInfoData) name:kRefreshDemandAndSupplyData object:nil];
}
