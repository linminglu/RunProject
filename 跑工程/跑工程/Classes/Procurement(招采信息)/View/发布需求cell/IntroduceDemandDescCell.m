...
{
    self.placeholder.text = textView.text.length > 0 ? @"" : @"详细介绍...";
}

- (void)textViewDidEndEditing:(UITextView *)textView
{
    self.demandDesc.desc = textView.text.length > 0 ? textView.text : @"";
}
...
- (void)setDemandDesc:(PGCDemand *)demandDesc
{
    ...
    if (demandDesc.desc.length > 0) {
        self.descTextView.text = demandDesc.desc;
    } else {
