...
- (void)supplyDetailBarItemEvent:(UIButton *)sender
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    switch (indexPath.section) {
        ...
        case 2:
        {
            ...
            descCell.supplyDesc = [self.dataSource[indexPath.section] firstObject];
            return descCell;
        }
            break;
        case 3:
...
{
    if (section == 1) {
        if (self.supply.contacts.count > 1) return _hidden ? 0.001 : 40;
    }
    return 0.001;
}
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    switch (indexPath.section) {
        ...
        case 2:
        {
            PGCSupply *supplyDesc = [self.dataSource[indexPath.section] firstObject];
            return [tableView cellHeightForIndexPath:indexPath model:supplyDesc keyPath:@"supplyDesc" cellClass:[DemandDetailDescCell class] contentViewWidth:SCREEN_WIDTH];
        }
            break;
        case 3:
        {
...
- (void)setSupply:(PGCSupply *)supply
{
    ...
    [self.dataSource insertObject:@[supply] atIndex:2];
                        ...
                        imageName:(NSString *)imageName
{
    ...
    [button addTarget:self action:@selector(supplyDetailBarItemEvent:) forControlEvents:UIControlEventTouchUpInside];
